...
# step5
# the number of significant SNP in each gene
# the number of significant SNP in each gene of each phenotype
...
# step6
# add phenotype name instead of ID
perl scr/03.add_name.pl -ref ID2metabolomeName.txt -input significant_SNP_ineachphynotype_summary.txt > significant_SNP_ineachphynotype_summary_with_annotation.txt
perl scr/04.merge_same_gene_name.pl -input significant_SNP_ineachphynotype_summary_with_annotation.txt > significant_SNP_ineachphynotype_summary_with_annotation_merged.txt
